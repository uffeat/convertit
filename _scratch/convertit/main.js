//
const foo = await import(`https://convertitdev.anvil.app/foo.js`);
console.log("foo:", foo);
//
...
const icons = {
  ...
  aspect_ratio: `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-aspect-ratio" viewBox="0 0 16 16">
  ...
  c_circle: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-c-circle" viewBox="0 0 16 16">
  ...
  minecart_loaded: `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-minecart-loaded" viewBox="0 0 16 16">
  ...
  rulers: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-rulers" viewBox="0 0 16 16">
  ...
  speedometer: `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-speedometer" viewBox="0 0 16 16">
...
(() => {
  ...
  text.insert.afterbegin(icons.c_circle);
  section.append(text);
})();
...
const properties = {
  ...
  mass: { base: "kg", icon: "minecart_loaded", units: ["kg", "g"] },
  speed: { base: "m/s", icon: "speedometer", units: ["km/h", "m/s", "mile/h"] },
  temperature: {
    base: "\u00B0C",
    icon: "thermometer",
    units: ["\u00B0C", "\u00B0F", "K"],
